...
class exam 
{
    static void Main(string[] args)
    {
        ...
        do//run loop infinite without condition
        {
            ...
            /*
                this part is not compulsory, just implemented for fun & satisfaction
---------------------------------------------------------------------------------------------------------------------------------------
            */
            else if (choise != 'y' || choise != 'Y' || choise != 'n'|| choise != 'N' ) //check for other character inputs and display invalid input if chatacter is not equal to {y,Y,n,N}
            {   
